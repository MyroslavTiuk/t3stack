...
import AddLegNew from "./addLegNew";

const EquityTransactionFormNew: React.FC<Props> = ({
  remove,
  initialState,
  addEquityLeg,
  addOptionLeg,
  ...
  const actions = [
    ...
    },
    {
      ...
      onClick: addOptionLeg({
        ...
        quantity:
          currentState.quantity && currentState.quantity > 100
...
export default EquityTransactionFormNew;
