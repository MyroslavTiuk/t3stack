  ...
  return (
    <Combobox onChange={onChange}>
      <div className="relative w-full cursor-default overflow-hidden rounded-md">
        <Combobox.Input
          className="p2 w-full rounded-md"
      ...
      <Transition
        ...
        afterLeave={() => setQuery("")}
      >
        <Combobox.Options className="mt-1 w-full rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
          <Options
