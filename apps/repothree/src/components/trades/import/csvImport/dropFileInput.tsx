  ...
  return (
    <div className="mx-auto flex max-w-xl flex-col gap-4">
      <Disclosure>
        {({ open }) => (
          <>
            <Disclosure.Button className="flex w-full justify-between rounded-lg border-2 border-solid border-teal-600 px-4 py-2 text-sm focus:outline-none focus-visible:ring focus-visible:ring-teal-600 focus-visible:ring-opacity-75">
              <span>
