...
import OptionTransactionTable from "./OptionTransactionTable";

const OptionTransactionList: React.FC<Props> = ({
  startDate,
  endDate,
  onClick,
  selectedIds,
    ...
    data.pages[pageIdx] && (
      <>
        <OptionTransactionTable
          optionTransactions={data.pages[pageIdx].trades}
          onClick={onClick}
...
export default OptionTransactionList;
