      ...
      <div className="fixed inset-0 flex items-center justify-center p-4">
        <Dialog.Panel className="w-full max-w-sm rounded-lg  bg-gradient-to-b from-neutral-50 to-neutral-200 p-4 drop-shadow">
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <button
              className="mt-4 flex w-full items-center justify-center gap-2 rounded-lg bg-blue px-3 py-2 font-semibold text-white no-underline drop-shadow transition duration-150 ease-in-out hover:bg-blue/70 disabled:cursor-not-allowed disabled:bg-blue/50 md:px-2"
              type="submit"
            >
