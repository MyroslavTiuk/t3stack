...
const NakedPut = ({ setExternalStrategies, loadedStrategies }: Props) => {
  const defaultEmpty = [
    {
      strategyName: "naked-put",
      strategyType: "put",
      strategyMode: "",
      strategyValue: 0,
      strategyQuantity: 1,
  ...
  return (
    <>
      <p className="mb-2 mt-3 text-sm font-normal text-orange">Naked Put</p>
