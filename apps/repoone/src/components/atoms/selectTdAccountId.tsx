...
const SelectTdAccountId: React.FC = () => {
  ...
  return (
    <div className="flex w-full flex-col items-center gap-4 py-10">
      ...
      {data.accountIds.map((accountId: any) => (
        <div
          key={accountId}
        ...
        >
          ...
          {!data?.mainAccountId && (
            <button
              ...
              className="flex items-center gap-2 rounded-lg bg-orange p-2 font-semibold text-white no-underline drop-shadow transition duration-150 ease-in-out hover:bg-orange/70 md:px-2"
            >
              Import trades
            </button>
          )}
