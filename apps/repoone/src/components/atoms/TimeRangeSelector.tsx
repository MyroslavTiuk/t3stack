              ...
              <Popover key="custom" as="div" className="relative">
                <Popover.Button
                  className={`font-bold text-neutral-700 underline ${
                    timeRange === range.timeRange ? "text-orange" : ""
                  }`}
                  onClick={() => setTimeRange(range.timeRange)}
                >
                  custom
                </Popover.Button>
                <Popover.Panel className="align-center absolute right-0 z-30 flex w-48 flex-col justify-center gap-3 rounded-md bg-neutral-50 p-4 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                  ...
                  <button
                    className="rounded-lg bg-orange px-10 py-2 font-semibold text-white no-underline transition hover:bg-orange/70"
                    onClick={() => {
