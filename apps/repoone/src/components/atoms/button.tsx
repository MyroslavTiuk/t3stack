...
const classTypes = (disabled: boolean) => ({
  [ButtonVariants.primary]: `text-white ${
    disabled ? "bg-orange/30" : "bg-orange"
  } hover:bg-orange/${disabled ? "30" : "70"}`,
  [ButtonVariants.secondary]: `text-white bg-blue${
    disabled ? "/30" : ""
  } hover:bg-blue/${disabled ? "30" : "70"} hover:bg-opacity-10`,
  [ButtonVariants.outlined]: `border-2 border-orange${
    disabled ? "/30" : ""
