export const theme = {
  ...
  color: {
    ...
    blue: "text-white bg-[#2D78C8] border border-transparent enabled:hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-[#2D78C8] dark:focus:ring-blue-800",
