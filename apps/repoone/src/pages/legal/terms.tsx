          ...
          <Link href="/">
            <div className="flex items-center lg:flex-1">
              <Image
                ...
                height={40}
              />
              <p className="mb-2font-extrabold ml-2 mt-4 text-lg font-bold tracking-tight text-orange">
                Track Greeks
              </p>
            </div>
          </Link>
            ...
            <div className="mx-auto px-6 lg:px-8">
              <div className="mx-auto">
                ...
                <div className="mt-6 max-w-prose text-gray-600 ">
                  ...
                  <ul>
                    ...
                    <li>
                      <p>
                        ...
                        TrackGreeks, LLC, 27758 santa margarita pwky, 167,
                        california 92691, United States.
                      </p>
                    </li>
                    <li>
                      <p>
                    ...
                    <li>
                      <p>
                        <strong>Website</strong> refers to TrackGreeks,
                        accessible from
                        <a
                          href="https://www.trackgreeks.com"
                          target="_blank"
                          rel="noreferrer"
                        >
                          trackgreeks.com
                  ...
                  <p className="mb-2 mt-4 text-lg font-bold">Acknowledgment</p>
                  <p>
                  ...
                  <p className="mb-2 mt-4 text-lg font-bold">Termination</p>
                  <p>
                  ...
                  <p className="mb-2 mt-4 text-lg font-bold">Governing Law</p>
                  <p>
                  ...
                  <p className=" text-lg">Severability</p>
                  <p>
                  ...
                  <p className="mb-2 mt-4 text-lg font-bold">Contact Us</p>
                  <p>
                    If you have any questions about these Terms and Conditions,
                    You can contact us:
                  </p>
                  <ul>
                    <li>By email: trackgreeks@gmail.com</li>
                  </ul>
                </div>
              </div>
            </div>
