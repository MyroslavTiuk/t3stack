  ...
  return (
    <>
      ...
      <Box p={6} maxW={1000}>
        ...
        <Text my={3}>
          Last updated June 20, 2022 This privacy notice for Option Scout INC
          (doing business as Option Scout) (&apos;Option Scout,&apos;
        ...
        <ul>
          <li>
            Visit our website at https://optionscout.com, or any website of ours
        ...
        <Text my={3}>
          ...
          information depending on how you interact with Option Scout and the
        ...
        <Text my={3}>
          ...
          debit/credit card numbers billing addresses contact or authentication
          data mailing addresses email addresses phone numbers names
        </Text>
        <Text my={3}>
        ...
        <Text my={3}>
          ...
          information about your devices location, which can be either precise
          ...
          use certain aspects of the Services. 2.
        </Text>
        ...
        <Text my={3}>
          ...
          products and services Develop and display personalized and relevant
          advertising content for our users Analyze how our services are used so
          we can improve them to engage and retain users Support our marketing
          ...
          improve user experience Legal Obligations. We may process your
        ...
        <Text my={3}>
          ...
          another company. Business Partners. We may share your information with
        ...
        <Text my={3}>
          ...
          (6) months past the termination of the user&apos;s account. When we
        ...
        <Text my={3}>
          ...
          than consent. Opting out of marketing and promotional communications:
        ...
        <Text my={3}>
          ...
          about your privacy rights, you may email us at alpha@optionscout.com.
        </Text>
        ...
        <Text my={3}>
          ...
          employment history, and financial information YES C. Protected
          ...
          example, an individual’s preferences and characteristics NO We may
          also collect other personal information outside of these categories
          ...
          alpha@optionscout.com, or by referring to the contact details at the
          ...
          Option Scout INC has not disclosed or sold any personal information to
          third parties for a business or commercial purpose in the preceding
          twelve (12) months. Option Scout INC will not sell personal
        ...
        <Text my={3}>
          ...
          at alpha@optionscout.com or by post to: Option Scout INC 18575
          Jamboree Rd Irvine, CA 92612 United States
        </Text>
