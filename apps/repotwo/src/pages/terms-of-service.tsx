  ...
  return (
    <>
      ...
      <Box p={6} maxW={1000}>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Option Scout Inc, 18575 Jamboree Rd,
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Option Scout, accessible from
              <a
                href="https://www.optionscout.com"
                target="_blank"
                rel="noreferrer"
              >
                optionscout.com
        ...
        <ul>
          <li>By email: alpha@optionscout.com</li>
        </ul>
      </Box>
    </>
  );
